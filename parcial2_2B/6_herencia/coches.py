...
(camion) Camiones("Negro", "Dina", "2020", 180,300,12,8,2500)

print("f Marca: (canionl.getMarca()) {camion1.getColor()), numeros de plazas:- (camionl.getPlazas()}\nModelo: (camion1.getModelo()} con una velocidad de (camioni.getVelocidad())-Km/h, una potencia de (camion1.getCaballaje()) hp, con (camion1.getEje())-ejes-y"
